...
function ShowSuccessMessage(title, message, isHTML, preventEsc) {
    ...
    htmlContent += '<div class="modal-dialog "><div class="modal-content" id="divSuccessMessage">';
...
function ShowFailureMessage(title, message, isHTML, preventEsc) {
    ...
    htmlContent += '<div class="modal-dialog "><div class="modal-content" id="divFailureMessage">';
    htmlContent += '<div class="modal-body">';
    htmlContent += '<div class="modal-wrapper">';
    ...
    if (localStorage.lang == 'ar')
        htmlContent += '<div class="modal-footer"><button type="button" class="btn btn-warning" style="float:right;" onclick="CloseFailureMessage()">إغلاق</button></div>';
    else
